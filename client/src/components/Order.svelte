...
<div class='order' class:loading={$isSubmittingLong || $isSubmittingShort}>
	...
	{#if !$address}
	<div class='note'>Abood is an open protocol to trade crypto perpetuals with low fees. <a data-intercept="true" on:click={() => {showModal('Connect')}}>Connect your wallet</a> on BaoBab to get started.</div>
