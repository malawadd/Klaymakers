...
export const CHAINDATA = {
	...
	1001: {
		...
		rpc: 'https://rpc.ankr.com/klaytn_testnet', // for walletconnect
		currencies: {
			weth: ADDRESS_ZERO,
			usdc: '0x3bBF3EaacC44b3ed11c1713D439aFC5f105871a5'
		},
		chainName: 'klaytn baobab',
		chainNameShort: 'baobab', //for mobile screens
		chainId: '0x3e9', //chainId number in hexadecimal prefixed by 0x
		nativeAssetName: 'KLAY',
		nativeAssetSymbol: 'KLAY',
